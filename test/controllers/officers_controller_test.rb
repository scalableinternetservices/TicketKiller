...
class OfficersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create officer" do
    assert_difference('Officer.count') do
      post officers_url, params: { officer: { last_seen: @officer.last_seen, lat: @officer.lat, long: @officer.long } }
    end
  ...
  test "should update officer" do
    patch officer_url(@officer), params: { officer: { last_seen: @officer.last_seen, lat: @officer.lat, long: @officer.long } }
